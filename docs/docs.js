...
var _terezka$elm_plot$Internal_View$toStyleConfig = F2(
	function (config, styles) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (x, y) {
...
var _terezka$elm_plot$Internal_View$useView = F2(
	function (config, value) {
		...
		switch (_p0.ctor) {
			case 'FromStyle':
				return A2(
					config.defaultView,
					A2(_terezka$elm_plot$Internal_View$toStyleConfig, config, _p0._0),
					value);
			case 'FromStyleDynamic':
				return A2(
					config.defaultView,
					A2(
						_terezka$elm_plot$Internal_View$toStyleConfig,
						config,
						_p0._0(value)),
					value);
			case 'FromCustom':
				return _p0._0(value);
			default:
				return A2(config.defaultView, _p0._0, value);
		}
	});
var _terezka$elm_plot$Internal_View$Config = F3(
	function (a, b, c) {
		return {view: a, defaultStyles: b, defaultView: c};
	});
var _terezka$elm_plot$Internal_View$FromConfig = function (a) {
	return {ctor: 'FromConfig', _0: a};
};
var _terezka$elm_plot$Internal_View$FromCustom = function (a) {
	return {ctor: 'FromCustom', _0: a};
};
var _terezka$elm_plot$Internal_View$FromStyleDynamic = function (a) {
	return {ctor: 'FromStyleDynamic', _0: a};
};
var _terezka$elm_plot$Internal_View$FromStyle = function (a) {
...
var _terezka$elm_plot$Internal_Types$Scale = F8(
	function (a, b, c, d, e, f, g, h) {
		return {ticks: a, bounds: b, padding: c, offset: d, lengthTotal: e, length: f, toSvgCoords: g, fromSvgCoords: h};
	});

var _terezka$elm_plot$Plot_Attributes$values = F2(
	function (values, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{values: values});
	});
var _terezka$elm_plot$Plot_Attributes$clearIntersections = function (config) {
	return _elm_lang$core$Native_Utils.update(
		config,
		{clearIntersections: true});
};
var _terezka$elm_plot$Plot_Attributes$position = F2(
	function (position, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{position: position});
	});
var _terezka$elm_plot$Plot_Attributes$anchor = F2(
	function (anchor, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{anchor: anchor});
	});
var _terezka$elm_plot$Plot_Attributes$format = F2(
	function (formatter, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{format: formatter});
	});
var _terezka$elm_plot$Plot_Attributes$viewCustom = F2(
	function (view, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				view: _terezka$elm_plot$Internal_View$FromCustom(view)
			});
	});
var _terezka$elm_plot$Plot_Attributes$viewDynamic = F2(
	function (toStyle, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				view: _terezka$elm_plot$Internal_View$FromStyleDynamic(toStyle)
			});
	});
var _terezka$elm_plot$Plot_Attributes$viewStatic = F2(
	function (styles, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				view: _terezka$elm_plot$Internal_View$FromStyle(styles)
			});
	});
var _terezka$elm_plot$Plot_Attributes$defaultTickStyle = {
	length: 7,
	stroke: 'black',
	width: 1,
	style: {ctor: '[]'},
...
var _terezka$elm_plot$Plot_Attributes$label = F2(
...
var _terezka$elm_plot$Plot_Attributes$defaultLabelStyle = {
	displace: {ctor: '_Tuple2', _0: 0, _1: 0},
	style: {ctor: '[]'},
	opacity: 1,
	strokeWidth: 1,
	fill: 'grey',
...
var _terezka$elm_plot$Plot_Attributes$defaultBarsStyle = {
	fill: 'grey',
	customAttrs: {ctor: '[]'}
};
var _terezka$elm_plot$Plot_Attributes$defaultScatterConfig = {
	stroke: 'black',
	fill: 'transparent',
	customAttrs: {ctor: '[]'},
	radius: 5
};
var _terezka$elm_plot$Plot_Attributes$viewHtml = F2(
	function (view, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{view: view});
	});
var _terezka$elm_plot$Plot_Attributes$radius = F2(
	function (radius, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{radius: radius});
	});
var _terezka$elm_plot$Plot_Attributes$width2 = F2(
	function (width, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{width: width});
	});
var _terezka$elm_plot$Plot_Attributes$length = F2(
	function (length, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{length: length});
	});
var _terezka$elm_plot$Plot_Attributes$classes = F2(
	function (classes, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{classes: classes});
	});
var _terezka$elm_plot$Plot_Attributes$customAttrs = F2(
	function (attrs, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{customAttrs: attrs});
	});
var _terezka$elm_plot$Plot_Attributes$interpolation = F2(
	function (interpolation, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{interpolation: interpolation});
	});
var _terezka$elm_plot$Plot_Attributes$fontSize = F2(
...
var _terezka$elm_plot$Plot_Attributes$displace = F2(
	function (displace, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{displace: displace});
	});
var _terezka$elm_plot$Plot_Attributes$opacity = F2(
	function (opacity, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{opacity: opacity});
	});
var _terezka$elm_plot$Plot_Attributes$fill = F2(
	function (fill, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{fill: fill});
	});
var _terezka$elm_plot$Plot_Attributes$strokeWidth = F2(
	function (strokeWidth, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{strokeWidth: strokeWidth});
	});
var _terezka$elm_plot$Plot_Attributes$stroke = F2(
	function (stroke, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{stroke: stroke});
	});
var _terezka$elm_plot$Plot_Attributes$applyBounds = F3(
	function (toLower, toUpper, scale) {
		return _elm_lang$core$Native_Utils.update(
			scale,
			{
				bounds: A2(
					_terezka$elm_plot$Internal_Types$Edges,
					toLower(scale.bounds.lower),
					toUpper(scale.bounds.upper))
			});
	});
var _terezka$elm_plot$Plot_Attributes$updateOffset = F3(
	function (lower, upper, scale) {
		return _elm_lang$core$Native_Utils.update(
			scale,
			{
				offset: A2(
					_terezka$elm_plot$Internal_Types$Edges,
					_elm_lang$core$Basics$toFloat(lower),
					_elm_lang$core$Basics$toFloat(upper))
			});
	});
var _terezka$elm_plot$Plot_Attributes$updateLength = F2(
	function (length, scale) {
		return _elm_lang$core$Native_Utils.update(
			scale,
			{
				lengthTotal: _elm_lang$core$Basics$toFloat(length)
			});
	});
var _terezka$elm_plot$Plot_Attributes$updatePadding = F2(
	function (_p0, scale) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.update(
			scale,
...
var _terezka$elm_plot$Plot_Attributes$rangeHighest = F2(
	function (toHighest, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				scales: A2(
					_terezka$elm_plot$Internal_Types$Oriented,
					A3(_terezka$elm_plot$Plot_Attributes$applyBounds, _elm_lang$core$Basics$identity, toHighest, config.scales.x),
					config.scales.y)
			});
	});
var _terezka$elm_plot$Plot_Attributes$rangeLowest = F2(
	function (toLowest, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				scales: A2(
					_terezka$elm_plot$Internal_Types$Oriented,
					A3(_terezka$elm_plot$Plot_Attributes$applyBounds, toLowest, _elm_lang$core$Basics$identity, config.scales.y),
					config.scales.y)
			});
	});
var _terezka$elm_plot$Plot_Attributes$domainHighest = F2(
	function (toHighest, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				scales: A2(
					_terezka$elm_plot$Internal_Types$Oriented,
					config.scales.x,
					A3(_terezka$elm_plot$Plot_Attributes$applyBounds, _elm_lang$core$Basics$identity, toHighest, config.scales.y))
			});
	});
var _terezka$elm_plot$Plot_Attributes$domainLowest = F2(
	function (toLowest, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
...
var _terezka$elm_plot$Plot_Attributes$id = F2(
	function (id, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{id: id});
	});
var _terezka$elm_plot$Plot_Attributes$margin = F2(
	function (_p2, config) {
		var _p3 = _p2;
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				scales: A2(
					_terezka$elm_plot$Internal_Types$Oriented,
					A3(_terezka$elm_plot$Plot_Attributes$updateOffset, _p3._3, _p3._1, config.scales.x),
					A3(_terezka$elm_plot$Plot_Attributes$updateOffset, _p3._0, _p3._2, config.scales.y))
			});
	});
var _terezka$elm_plot$Plot_Attributes$size = F2(
	function (_p4, config) {
		var _p5 = _p4;
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				scales: A2(
					_terezka$elm_plot$Internal_Types$Oriented,
					A2(_terezka$elm_plot$Plot_Attributes$updateLength, _p5._0, config.scales.x),
					A2(_terezka$elm_plot$Plot_Attributes$updateLength, _p5._1, config.scales.y))
			});
	});
var _terezka$elm_plot$Plot_Attributes$padding = F2(
		...
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				scales: A2(
					_terezka$elm_plot$Internal_Types$Oriented,
					config.scales.x,
					A2(_terezka$elm_plot$Plot_Attributes$updatePadding, padding, config.scales.y))
			});
	});
var _terezka$elm_plot$Plot_Attributes$defaultScale = function (length) {
	return {
		...
		lengthTotal: length,
		length: length,
		toSvgCoords: _elm_lang$core$Basics$identity,
		fromSvgCoords: _elm_lang$core$Basics$identity
	};
};
var _terezka$elm_plot$Plot_Attributes$defaultConfig = {
	id: 'elm-plot',
	classes: {ctor: '[]'},
	style: {ctor: '[]'},
	getHintInfo: _elm_lang$core$Basics$always(
		{
			xValue: 0,
			yValues: {ctor: '[]'},
			isLeftSide: true
	...
	scales: A2(
		_terezka$elm_plot$Internal_Types$Oriented,
		_terezka$elm_plot$Plot_Attributes$defaultScale(800),
		_terezka$elm_plot$Plot_Attributes$defaultScale(500))
};
var _terezka$elm_plot$Plot_Attributes$style = F2(
	function (style, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				style: A2(
					_elm_lang$core$Basics_ops['++'],
					_terezka$elm_plot$Plot_Attributes$defaultConfig.style,
					A2(
						_elm_lang$core$Basics_ops['++'],
						style,
						{
...
var _terezka$elm_plot$Plot_Attributes$Plot = F5(
	function (a, b, c, d, e) {
		return {id: a, classes: b, style: c, getHintInfo: d, scales: e};
	});
var _terezka$elm_plot$Plot_Attributes$HintInfo = F3(
	function (a, b, c) {
		return {xValue: a, yValues: b, isLeftSide: c};
	});
var _terezka$elm_plot$Plot_Attributes$Hint = F2(
	function (a, b) {
		return {view: a, lineStyle: b};
	});
var _terezka$elm_plot$Plot_Attributes$Scatter = F5(
	function (a, b, c, d, e) {
		return {radius: a, fill: b, stroke: c, customAttrs: d, radius: e};
	});
var _terezka$elm_plot$Plot_Attributes$AxisLabelInfo = F4(
	function (a, b, c, d) {
		return {value: a, index: b, orientation: c, text: d};
	});
var _terezka$elm_plot$Plot_Attributes$Axis = F8(
	function (a, b, c, d, e, f, g, h) {
		return {tick: a, label: b, lineStyle: c, orientation: d, anchor: e, clearIntersections: f, position: g, classes: h};
	});
var _terezka$elm_plot$Plot_Attributes$BarLabelInfo = F4(
	function (a, b, c, d) {
		return {index: a, xValue: b, yValue: c, text: d};
	});
var _terezka$elm_plot$Plot_Attributes$Group = F2(
	function (a, b) {
		return {xValue: a, yValues: b};
	});
var _terezka$elm_plot$Plot_Attributes$BarsStyle = F2(
	function (a, b) {
		return {fill: a, customAttrs: b};
	});
var _terezka$elm_plot$Plot_Attributes$Bars = F3(
	function (a, b, c) {
...
var _terezka$elm_plot$Plot_Attributes$Grid = F5(
	function (a, b, c, d, e) {
...
var _terezka$elm_plot$Plot_Attributes$LabelStyle = F8(
	function (a, b, c, d, e, f, g, h) {
		return {displace: a, style: b, opacity: c, fill: d, strokeWidth: e, stroke: f, classes: g, customAttrs: h};
	});
var _terezka$elm_plot$Plot_Attributes$Tick = F2(
	function (a, b) {
		return {view: a, values: b};
	});
var _terezka$elm_plot$Plot_Attributes$TickStyle = F6(
	function (a, b, c, d, e, f) {
		return {length: a, stroke: b, width: c, style: d, classes: e, customAttrs: f};
	});
var _terezka$elm_plot$Plot_Attributes$Y = {ctor: 'Y'};
var _terezka$elm_plot$Plot_Attributes$stackByY = function (config) {
	return _elm_lang$core$Native_Utils.update(
		config,
		{stackBy: _terezka$elm_plot$Plot_Attributes$Y});
};
...
var _terezka$elm_plot$Plot_Attributes$Bezier = {ctor: 'Bezier'};
var _terezka$elm_plot$Plot_Attributes$FormatFromFunc = function (a) {
	return {ctor: 'FormatFromFunc', _0: a};
};
var _terezka$elm_plot$Plot_Attributes$FormatFromList = function (a) {
	return {ctor: 'FormatFromList', _0: a};
};
var _terezka$elm_plot$Plot_Attributes$AnchorOuter = {ctor: 'AnchorOuter'};
var _terezka$elm_plot$Plot_Attributes$AnchorInner = {ctor: 'AnchorInner'};
var _terezka$elm_plot$Plot_Attributes$PositionAtZero = {ctor: 'PositionAtZero'};
var _terezka$elm_plot$Plot_Attributes$PositionHighest = {ctor: 'PositionHighest'};
var _terezka$elm_plot$Plot_Attributes$PositionLowest = {ctor: 'PositionLowest'};
var _terezka$elm_plot$Plot_Attributes$Percentage = function (a) {
	return {ctor: 'Percentage', _0: a};
};
var _terezka$elm_plot$Plot_Attributes$defaultBarsConfig = {
	stackBy: _terezka$elm_plot$Plot_Attributes$X,
	label: {
		view: _terezka$elm_plot$Internal_View$FromConfig(_terezka$elm_plot$Plot_Attributes$defaultLabelStyle),
		format: _terezka$elm_plot$Plot_Attributes$FormatFromFunc(
			_elm_lang$core$Basics$always(''))
	},
	maxWidth: _terezka$elm_plot$Plot_Attributes$Percentage(100)
};
var _terezka$elm_plot$Plot_Attributes$maxBarWidthPer = F2(
	function (max, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				maxWidth: _terezka$elm_plot$Plot_Attributes$Percentage(max)
			});
	});
var _terezka$elm_plot$Plot_Attributes$Fixed = function (a) {
	return {ctor: 'Fixed', _0: a};
};
var _terezka$elm_plot$Plot_Attributes$maxBarWidth = F2(
	function (max, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				maxWidth: _terezka$elm_plot$Plot_Attributes$Fixed(max)
			});
	});
...
var _terezka$elm_plot$Plot_Attributes$defaultTickConfig = {
	view: _terezka$elm_plot$Internal_View$FromConfig(_terezka$elm_plot$Plot_Attributes$defaultTickStyle),
	values: _terezka$elm_plot$Plot_Attributes$ValuesAuto
};
var _terezka$elm_plot$Plot_Attributes$defaultAxisConfig = {
	tick: _terezka$elm_plot$Plot_Attributes$defaultTickConfig,
	label: {
		view: _terezka$elm_plot$Internal_View$FromConfig(_terezka$elm_plot$Plot_Attributes$defaultLabelStyle),
		format: _terezka$elm_plot$Plot_Attributes$FormatFromFunc(
			function (_p6) {
	...
	position: _terezka$elm_plot$Plot_Attributes$PositionAtZero,
	classes: {ctor: '[]'}
};
var _terezka$elm_plot$Plot_Attributes$tick = F2(
	function (attributes, config) {
		return _elm_lang$core$Native_Utils.update(
			config,
			{
				tick: A3(
					...
					_terezka$elm_plot$Plot_Attributes$defaultTickConfig,
					attributes)
			});
	});
var _terezka$elm_plot$Plot_Attributes$ValuesFromDelta = function (a) {
	return {ctor: 'ValuesFromDelta', _0: a};
};
var _terezka$elm_plot$Plot_Attributes$ValuesFromList = function (a) {
	return {ctor: 'ValuesFromList', _0: a};
};
...
var _terezka$elm_plot$Internal_Scale$getInnerLength = function (scale) {
	return (scale.lengthTotal - scale.offset.lower) - scale.offset.upper;
};
var _terezka$elm_plot$Internal_Scale$getDifference = F2(
	function (a, b) {
		return _elm_lang$core$Basics$abs(a - b);
	});
var _terezka$elm_plot$Internal_Scale$ceilToNearest = F2(
	function (precision, value) {
		return _elm_lang$core$Basics$toFloat(
			_elm_lang$core$Basics$ceiling(value / precision)) * precision;
	});
var _terezka$elm_plot$Internal_Scale$pixelsToValue = F3(
	function (length, range, pixels) {
		return (range * pixels) / length;
	});
var _terezka$elm_plot$Internal_Scale$getRange = function (_p0) {
	var _p1 = _p0;
	var _p2 = _p1.bounds;
	return (_elm_lang$core$Native_Utils.cmp(_p2.upper - _p2.lower, 0) > 0) ? (_p2.upper - _p2.lower) : 1;
};
var _terezka$elm_plot$Internal_Scale$getLowest = function (values) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_elm_lang$core$List$minimum(values));
};
var _terezka$elm_plot$Internal_Scale$getHighest = function (values) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		10,
		_elm_lang$core$List$maximum(values));
};
var _terezka$elm_plot$Internal_Scale$getEdges = function (range) {
	return {
		ctor: '_Tuple2',
		_0: _terezka$elm_plot$Internal_Scale$getLowest(range),
		_1: _terezka$elm_plot$Internal_Scale$getHighest(range)
	};
};
var _terezka$elm_plot$Internal_Scale$getEdgesX = function (points) {
	return _terezka$elm_plot$Internal_Scale$getEdges(
		A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$first, points));
};
var _terezka$elm_plot$Internal_Scale$getEdgesY = function (points) {
	return _terezka$elm_plot$Internal_Scale$getEdges(
...
var _terezka$elm_plot$Internal_Scale$unScaleValue = F2(
	function (_p3, v) {
		var _p4 = _p3;
		return (((v - _p4.offset.lower) * _terezka$elm_plot$Internal_Scale$getRange(_p4)) / _p4.length) + _p4.bounds.lower;
	});
var _terezka$elm_plot$Internal_Scale$fromSvgCoordsX = F2(
	function (scales, _p5) {
		var _p6 = _p5;
		return {
			ctor: '_Tuple2',
			_0: A2(_terezka$elm_plot$Internal_Scale$unScaleValue, scales.x, _p6._0),
			_1: A2(_terezka$elm_plot$Internal_Scale$unScaleValue, scales.y, scales.y.length - _p6._1)
		};
	});
var _terezka$elm_plot$Internal_Scale$fromSvgCoordsY = F2(
	function (scales, _p7) {
		var _p8 = _p7;
		return A2(
			_terezka$elm_plot$Internal_Scale$fromSvgCoordsX,
			scales,
...
var _terezka$elm_plot$Internal_Scale$scaleValue = F2(
	function (_p9, v) {
		var _p10 = _p9;
		return ((v * _p10.length) / _terezka$elm_plot$Internal_Scale$getRange(_p10)) + _p10.offset.lower;
	});
var _terezka$elm_plot$Internal_Scale$toSvgCoordsX = F2(
	function (scales, _p11) {
		var _p12 = _p11;
		return {
			ctor: '_Tuple2',
			_0: A2(_terezka$elm_plot$Internal_Scale$scaleValue, scales.x, _p12._0 - scales.x.bounds.lower),
			_1: A2(_terezka$elm_plot$Internal_Scale$scaleValue, scales.y, scales.y.bounds.upper - _p12._1)
		};
	});
var _terezka$elm_plot$Internal_Scale$toSvgCoordsY = F2(
	function (scales, _p13) {
		var _p14 = _p13;
		return A2(
			_terezka$elm_plot$Internal_Scale$toSvgCoordsX,
			scales,
			{ctor: '_Tuple2', _0: _p14._1, _1: _p14._0});
	});
var _terezka$elm_plot$Internal_Scale$flipPlotToOrientation = F2(
	function (orientation, plot) {
		var _p15 = orientation;
		if (_p15.ctor === 'X') {
			return plot;
		} else {
			return _elm_lang$core$Native_Utils.update(
				plot,
				{
					scales: {x: plot.scales.y, y: plot.scales.x}
				});
		}
	});
var _terezka$elm_plot$Internal_Scale$postProcessScales = function (_p16) {
	var _p17 = _p16;
	var _p19 = _p17.y;
	var _p18 = _p17.x;
	return {
		x: _elm_lang$core$Native_Utils.update(
			_p18,
			{
				length: _terezka$elm_plot$Internal_Scale$getInnerLength(_p18)
			}),
		y: _elm_lang$core$Native_Utils.update(
			_p19,
			{
				length: _terezka$elm_plot$Internal_Scale$getInnerLength(_p19)
			})
	};
};
var _terezka$elm_plot$Internal_Scale$postProcessScaleTranslator = function (_p20) {
	var _p21 = _p20;
	var _p22 = _p21;
	return {
		x: _elm_lang$core$Native_Utils.update(
			_p21.x,
			{
				toSvgCoords: _terezka$elm_plot$Internal_Scale$toSvgCoordsX(_p22),
				fromSvgCoords: _terezka$elm_plot$Internal_Scale$fromSvgCoordsX(_p22)
			}),
		y: _elm_lang$core$Native_Utils.update(
			_p21.y,
			{
				toSvgCoords: _terezka$elm_plot$Internal_Scale$toSvgCoordsY(_p22),
				fromSvgCoords: _terezka$elm_plot$Internal_Scale$fromSvgCoordsY(_p22)
			})
	};
};
var _terezka$elm_plot$Internal_Scale$postProcessTranslator = function (plot) {
	return _elm_lang$core$Native_Utils.update(
		plot,
		{
			scales: _terezka$elm_plot$Internal_Scale$postProcessScaleTranslator(plot.scales)
		});
};
var _terezka$elm_plot$Internal_Scale$postProcessPlot = function (plot) {
	return _terezka$elm_plot$Internal_Scale$postProcessTranslator(
		_elm_lang$core$Native_Utils.update(
			plot,
			{
				scales: _terezka$elm_plot$Internal_Scale$postProcessScales(plot.scales)
			}));
};
var _terezka$elm_plot$Internal_Scale$getClosest = F3(
	function (value, candidate, closest) {
		var _p23 = closest;
		if (_p23.ctor === 'Just') {
			var _p24 = _p23._0;
			return (_elm_lang$core$Native_Utils.cmp(
				A2(_terezka$elm_plot$Internal_Scale$getDifference, value, candidate),
				A2(_terezka$elm_plot$Internal_Scale$getDifference, value, _p24)) < 0) ? _elm_lang$core$Maybe$Just(candidate) : _elm_lang$core$Maybe$Just(_p24);
		} else {
			return _elm_lang$core$Maybe$Just(candidate);
		}
	});
var _terezka$elm_plot$Internal_Scale$toNearestX = F2(
	function (scales, value) {
		return A3(
			_elm_lang$core$List$foldr,
			_terezka$elm_plot$Internal_Scale$getClosest(value),
			_elm_lang$core$Maybe$Nothing,
			{ctor: '[]'});
	});
var _terezka$elm_plot$Internal_Scale$updateScaleTicks = F2(
	function (scale, ticks) {
		return _elm_lang$core$Native_Utils.update(
			scale,
			{ticks: ticks});
	});
var _terezka$elm_plot$Internal_Scale$updatePlotTicks = F3(
	function (orientation, scales, ticks) {
		var _p25 = orientation;
		if (_p25.ctor === 'X') {
			return A2(
				_terezka$elm_plot$Internal_Types$Oriented,
				A2(_terezka$elm_plot$Internal_Scale$updateScaleTicks, scales.x, ticks),
				scales.y);
		} else {
			return A2(
				_terezka$elm_plot$Internal_Types$Oriented,
				scales.x,
				A2(_terezka$elm_plot$Internal_Scale$updateScaleTicks, scales.y, ticks));
		}
	});
var _terezka$elm_plot$Internal_Scale$addBarsBoundsPadding = function (bounds) {
	return A2(
		_terezka$elm_plot$Internal_Types$Oriented,
		{lower: bounds.x.lower - 0.5, upper: bounds.x.upper + 0.5},
		{lower: 0, upper: bounds.y.upper});
};
var _terezka$elm_plot$Internal_Scale$addAreaBoundsPadding = function (bounds) {
	return A2(
		_terezka$elm_plot$Internal_Types$Oriented,
		bounds.x,
		{
			lower: A2(_elm_lang$core$Basics$min, 0, bounds.y.lower),
			upper: bounds.y.upper
		});
};
var _terezka$elm_plot$Internal_Scale$foldSingleBounds = F2(
	function (boundsA, boundsB) {
		return {
			lower: A2(_elm_lang$core$Basics$min, boundsA.lower, boundsB.lower),
			upper: A2(_elm_lang$core$Basics$max, boundsA.upper, boundsB.upper)
		};
	});
var _terezka$elm_plot$Internal_Scale$foldBounds = F2(
	function (newBounds, oldBounds) {
		return {
			x: A2(_terezka$elm_plot$Internal_Scale$foldSingleBounds, oldBounds.x, newBounds.x),
			y: A2(_terezka$elm_plot$Internal_Scale$foldSingleBounds, oldBounds.y, newBounds.y)
		};
	});
var _terezka$elm_plot$Internal_Scale$toBounds = function (values) {
	return {
		lower: _terezka$elm_plot$Internal_Scale$getLowest(values),
		upper: _terezka$elm_plot$Internal_Scale$getHighest(values)
	};
};
var _terezka$elm_plot$Internal_Scale$updateBoundsFromPoints = function (points) {
	return function (_p26) {
		var _p27 = _p26;
		return A2(
			_terezka$elm_plot$Internal_Types$Oriented,
			_terezka$elm_plot$Internal_Scale$toBounds(_p27._0),
			_terezka$elm_plot$Internal_Scale$toBounds(_p27._1));
	}(
		_elm_lang$core$List$unzip(points));
};
var _terezka$elm_plot$Internal_Scale$updateBoundsArea = function (points) {
	return _terezka$elm_plot$Internal_Scale$addAreaBoundsPadding(
		_terezka$elm_plot$Internal_Scale$updateBoundsFromPoints(points));
};
var _terezka$elm_plot$Internal_Scale$updateBoundsBars = function (points) {
	return _terezka$elm_plot$Internal_Scale$addBarsBoundsPadding(
		_terezka$elm_plot$Internal_Scale$updateBoundsFromPoints(points));
};
var _terezka$elm_plot$Internal_Scale$updatePlotBounds = F2(
	function (_p28, bounds) {
		var _p29 = _p28;
		return {
			x: _elm_lang$core$Native_Utils.update(
				_p29.x,
...
var _terezka$elm_plot$Internal_Scale$updatePlotScales = F2(
	function (plot, scales) {
		return _elm_lang$core$Native_Utils.update(
			plot,
			{scales: scales});
	});
...
var _terezka$elm_plot$Internal_Draw$toClipPathId = function (plot) {
	return A2(_elm_lang$core$Basics_ops['++'], plot.id, '__scale-clip-path');
};
var _terezka$elm_plot$Internal_Draw$pointToString = F2(
	function (plot, point) {
		var _p9 = plot.scales.x.toSvgCoords(point);
		var x = _p9._0;
		var y = _p9._1;
		return A2(
			_elm_lang$core$Basics_ops['++'],
...
var _terezka$elm_plot$Internal_Draw$toBezierPoints = F3(
	function (_p12, _p11, _p10) {
		...
		return {
			ctor: '_Tuple2',
			_0: {ctor: '_Tuple2', _0: _p16 - (((_p15._0 - _p13._0) / 2) * _terezka$elm_plot$Internal_Draw$magnitude), _1: _p17 - (((_p15._1 - _p13._1) / 2) * _terezka$elm_plot$Internal_Draw$magnitude)},
			_1: {ctor: '_Tuple2', _0: _p16, _1: _p17}
		};
	});
var _terezka$elm_plot$Internal_Draw$toPathTypeStringS = F4(
	function (plot, p1, p2, p3) {
		var _p18 = A3(_terezka$elm_plot$Internal_Draw$toBezierPoints, p1, p2, p3);
		var point1 = _p18._0;
		var point2 = _p18._1;
		return A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					A2(_terezka$elm_plot$Internal_Draw$pointToString, plot, point1),
					A2(
						_elm_lang$core$Basics_ops['++'],
						',',
						A2(_terezka$elm_plot$Internal_Draw$pointToString, plot, point2)))));
	});
var _terezka$elm_plot$Internal_Draw$toPathTypeStringSinglePoint = F3(
	function (plot, typeString, point) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			typeString,
			A2(
				_elm_lang$core$Basics_ops['++'],
				' ',
				A2(_terezka$elm_plot$Internal_Draw$pointToString, plot, point)));
	});
var _terezka$elm_plot$Internal_Draw$toPathTypeString = F2(
	function (plot, pathType) {
		var _p19 = pathType;
		switch (_p19.ctor) {
			case 'M':
				return A3(_terezka$elm_plot$Internal_Draw$toPathTypeStringSinglePoint, plot, 'M', _p19._0);
			case 'L':
				return A3(_terezka$elm_plot$Internal_Draw$toPathTypeStringSinglePoint, plot, 'L', _p19._0);
			case 'S':
				return A4(_terezka$elm_plot$Internal_Draw$toPathTypeStringS, plot, _p19._0, _p19._1, _p19._2);
			default:
				return 'Z';
		}
	});
var _terezka$elm_plot$Internal_Draw$toPath = F2(
	function (plot, pathParts) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (part, result) {
					return A2(
						_elm_lang$core$Basics_ops['++'],
						result,
						A2(_terezka$elm_plot$Internal_Draw$toPathTypeString, plot, part));
				}),
			'',
			pathParts);
	});
...
var _terezka$elm_plot$Internal_Draw$S = F3(
	function (a, b, c) {
		return {ctor: 'S', _0: a, _1: b, _2: c};
	});
var _terezka$elm_plot$Internal_Draw$toSPathTypes = F2(
		...
		while (true) {
			...
			if ((_p25.ctor === '::') && (_p25._1.ctor === '::')) {
				if (_p25._1._1.ctor === '[]') {
					...
					return {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Draw$S, _p25._0, _p26, _p26),
						_1: result
					};
				} else {
					if (_p25._1._1._1.ctor === '[]') {
						var _p28 = _p25._1._1._0;
						var _p27 = _p25._1._0;
						var _v12 = {
							ctor: '::',
							_0: A3(_terezka$elm_plot$Internal_Draw$S, _p25._0, _p27, _p28),
							_1: result
						},
							_v13 = {
							ctor: '::',
						...
						var _p30 = _p25._1._1._0;
						var _p29 = _p25._1._0;
						var _v14 = {
							ctor: '::',
							_0: A3(_terezka$elm_plot$Internal_Draw$S, _p25._0, _p29, _p30),
							_1: result
						},
							_v15 = {
							ctor: '::',
							_0: _p29,
							_1: {ctor: '::', _0: _p30, _1: _p25._1._1._1}
						};
						result = _v14;
						points = _v15;
						continue toSPathTypes;
...
var _terezka$elm_plot$Internal_Draw$M = function (a) {
	return {ctor: 'M', _0: a};
};
var _terezka$elm_plot$Internal_Draw$L = function (a) {
	return {ctor: 'L', _0: a};
};
var _terezka$elm_plot$Internal_Draw$toLinePath = function (interpolation) {
	var _p31 = interpolation;
	if (_p31.ctor === 'NoInterpolation') {
...
var _terezka$elm_plot$Internal_Tick$defaultView = F2(
	function (_p1, _p0) {
		var _p2 = _p1;
		var _p3 = _p0;
		var styleFinal = A2(
...
var _terezka$elm_plot$Internal_Tick$toView = function (_p4) {
	var _p5 = _p4;
	return _terezka$elm_plot$Internal_View$useView(
		{view: _p5.view, defaultStyles: _terezka$elm_plot$Plot_Attributes$defaultTickStyle, defaultView: _terezka$elm_plot$Internal_Tick$defaultView});
};

var _terezka$elm_plot$Internal_Label$defaultView = F2(
	function (config, info) {
		var _p0 = config.displace;
		var dx = _p0._0;
		var dy = _p0._1;
		return A2(
				...
				_elm_lang$core$List$append,
				{
					...
					_1: {
						...
						_0: _elm_lang$svg$Svg_Attributes$opacity(
							_elm_lang$core$Basics$toString(config.opacity)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$fill(config.fill),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$style(
									_terezka$elm_plot$Internal_Draw$toStyle(config.style)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$stroke(
										A2(
											_elm_lang$core$Basics_ops['++'],
											_elm_lang$core$Basics$toString(config.stroke),
											'px')),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$strokeWidth(
											A2(
												_elm_lang$core$Basics_ops['++'],
												_elm_lang$core$Basics$toString(config.strokeWidth),
												'px')),
										_1: {
											ctor: '::',
											_0: _elm_lang$svg$Svg_Attributes$class(
												A2(
													_elm_lang$core$String$join,
													' ',
													{ctor: '::', _0: 'elm-plot__label__default-view', _1: config.classes})),
											_1: {ctor: '[]'}
										}
									}
								}
				...
				config.customAttrs),
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$svg$Svg$text(info.text),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	});
var _terezka$elm_plot$Internal_Label$toLabelText = F2(
	function (config, infos) {
		var _p1 = config.format;
		if (_p1.ctor === 'FormatFromFunc') {
			return A2(
				_elm_lang$core$List$map,
				function (info) {
					return _elm_lang$core$Native_Utils.update(
...
var _terezka$elm_plot$Internal_Label$viewConfig = function (config) {
	return {view: config.view, defaultStyles: _terezka$elm_plot$Plot_Attributes$defaultLabelStyle, defaultView: _terezka$elm_plot$Internal_Label$defaultView};
};
var _terezka$elm_plot$Internal_Label$view = F3(
	function (config, wrapView, infos) {
		return A3(
			_elm_lang$core$List$map2,
			wrapView,
			infos,
			A2(
				_elm_lang$core$List$map,
				_terezka$elm_plot$Internal_View$useView(
					_terezka$elm_plot$Internal_Label$viewConfig(config)),
				A2(_terezka$elm_plot$Internal_Label$toLabelText, config, infos)));
	});

var _terezka$elm_plot$Internal_Line$view = F3(
	function (plot, config, points) {
		var instructions = function () {
			var _p0 = points;
			if (_p0.ctor === '::') {
				var _p1 = _p0._0;
				return A2(
					_terezka$elm_plot$Internal_Draw$toPath,
					plot,
					{
						ctor: '::',
						_0: _terezka$elm_plot$Internal_Draw$M(_p1),
						_1: A2(
							_terezka$elm_plot$Internal_Draw$toLinePath,
							config.interpolation,
							{ctor: '::', _0: _p1, _1: _p0._1})
					});
			} else {
				return '';
			}
		...
		return A2(
			...
			A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$d(instructions),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$opacity(
							_elm_lang$core$Basics$toString(config.opacity)),
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$stroke(config.stroke),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$strokeWidth(
										A2(
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$fill('tranparent'),
										_1: {
											ctor: '::',
											...
											_1: {
												...
												_0: _elm_lang$svg$Svg_Attributes$clipPath(
													A2(
														...
														A2(
															_elm_lang$core$Basics_ops['++'],
															_terezka$elm_plot$Internal_Draw$toClipPathId(plot),
															')'))),
												_1: {ctor: '[]'}
											}
										}
...
var _terezka$elm_plot$Internal_Axis$zipWithDistance = F5(
	function (orientation, hasZero, lowerThanZero, index, value) {
		...
		return {index: distance, value: value, orientation: orientation, text: ''};
	});
var _terezka$elm_plot$Internal_Axis$toIndexInfo = F2(
	function (orientation, values) {
		...
		return A2(
			_elm_lang$core$List$indexedMap,
			A3(_terezka$elm_plot$Internal_Axis$zipWithDistance, orientation, hasZero, lowerThanZero),
			values);
	});
...
var _terezka$elm_plot$Internal_Axis$getFirstValue = F2(
	function (delta, lowest) {
		return A2(_terezka$elm_plot$Internal_Scale$ceilToNearest, delta, lowest);
	});
var _terezka$elm_plot$Internal_Axis$toValuesFromDelta = F2(
	function (delta, scale) {
		var firstValue = A2(_terezka$elm_plot$Internal_Axis$getFirstValue, delta, scale.bounds.lower);
		var tickCount = A4(
			_terezka$elm_plot$Internal_Axis$getCount,
			delta,
			scale.bounds.lower,
			_terezka$elm_plot$Internal_Scale$getRange(scale),
			firstValue);
		return A2(
			_elm_lang$core$List$map,
...
var _terezka$elm_plot$Internal_Axis$toValuesFromCount = F2(
	function (appxCount, scale) {
		return A2(
			...
			A2(
				_terezka$elm_plot$Internal_Axis$getDelta,
				_terezka$elm_plot$Internal_Scale$getRange(scale),
				appxCount),
			scale);
	});
...
var _terezka$elm_plot$Internal_Axis$getValues = function (config) {
	...
	switch (_p0.ctor) {
		...
		case 'ValuesFromDelta':
			return _terezka$elm_plot$Internal_Axis$toValuesFromDelta(_p0._0);
		default:
			return _elm_lang$core$Basics$always(_p0._0);
	}
};
var _terezka$elm_plot$Internal_Axis$toLabelValues = F2(
	function (config, tickValues) {
		var _p1 = config.label.values;
		switch (_p1.ctor) {
			case 'ValuesFromList':
				return _p1._0;
			case 'ValuesFromDelta':
...
var _terezka$elm_plot$Internal_Axis$isCrossing = F2(
	function (plot, value) {
		return !A2(_elm_lang$core$List$member, value, plot.scales.y.ticks);
	});
var _terezka$elm_plot$Internal_Axis$filterValues = F3(
	function (plot, config, values) {
		return config.clearIntersections ? A2(
			_elm_lang$core$List$filter,
			_terezka$elm_plot$Internal_Axis$isCrossing(plot),
			values) : values;
	});
var _terezka$elm_plot$Internal_Axis$toTickValues = F2(
	function (plot, config) {
		return A3(
			...
			plot,
			config,
			A2(_terezka$elm_plot$Internal_Axis$getValues, config.tick.values, plot.scales.x));
	});
...
var _terezka$elm_plot$Internal_Axis$getAxisPosition = F2(
	function (_p10, position) {
		var _p11 = _p10;
		var _p13 = _p11.bounds;
		var _p12 = position;
		switch (_p12.ctor) {
			case 'PositionAtZero':
				return A3(_elm_lang$core$Basics$clamp, _p13.lower, _p13.upper, 0);
			case 'PositionLowest':
				return _p13.lower;
			default:
				return _p13.upper;
...
var _terezka$elm_plot$Internal_Axis$placeTick = F5(
	function (plot, _p14, axisPosition, view, info) {
		var _p15 = _p14;
		return A2(
			_elm_lang$svg$Svg$g,
			{
				...
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							' ',
							A2(_terezka$elm_plot$Internal_Axis$toRotate, _p15.anchor, _p15.orientation)))),
				_1: {
					ctor: '::',
...
var _terezka$elm_plot$Internal_Axis$getLabelPosition = F4(
	function (plot, _p16, axisPosition, info) {
		var _p17 = _p16;
		return _terezka$elm_plot$Internal_Draw$toTranslate(
			A2(
				_terezka$elm_plot$Internal_Draw$addDisplacement,
				A2(_terezka$elm_plot$Internal_Axis$getDisplacement, _p17.anchor, _p17.orientation),
				plot.scales.x.toSvgCoords(
					{ctor: '_Tuple2', _0: info.value, _1: axisPosition})));
	});
var _terezka$elm_plot$Internal_Axis$viewLabel = F5(
	function (plot, config, axisPosition, info, view) {
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$transform(
					A4(_terezka$elm_plot$Internal_Axis$getLabelPosition, plot, config, axisPosition, info)),
				_1: {
					ctor: '::',
...
var _terezka$elm_plot$Internal_Axis$viewAxisLine = F3(
	function (config, plot, position) {
		return A3(
			_terezka$elm_plot$Internal_Line$view,
			plot,
			config,
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: plot.scales.x.bounds.lower, _1: position},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: plot.scales.x.bounds.upper, _1: position},
					_1: {ctor: '[]'}
				}
			});
	});
var _terezka$elm_plot$Internal_Axis$view = F2(
	function (plot, _p18) {
		var _p19 = _p18;
		var _p21 = _p19.orientation;
		var _p20 = _p19;
		var axisPosition = A2(_terezka$elm_plot$Internal_Axis$getAxisPosition, plot.scales.y, _p19.position);
		var tickValues = A2(_terezka$elm_plot$Internal_Axis$toTickValues, plot, _p20);
		var labelValues = A2(_terezka$elm_plot$Internal_Axis$toLabelValues, _p20, tickValues);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Internal_Draw$classAttributeOriented, 'axis', _p21, _p19.classes),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A3(_terezka$elm_plot$Internal_Axis$viewAxisLine, _p19.lineStyle, plot, axisPosition),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$svg$Svg$g,
						...
						A2(
							...
							A4(
								...
								_p20,
								axisPosition,
								_terezka$elm_plot$Internal_Tick$toView(_p19.tick)),
							A2(_terezka$elm_plot$Internal_Axis$toIndexInfo, _p21, tickValues))),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$svg$Svg$g,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$style(
										A2(_terezka$elm_plot$Internal_Axis$toAnchorStyle, _p19.anchor, _p21)),
									_1: {ctor: '[]'}
								}
							},
							A3(
								...
								_p19.label,
								A3(_terezka$elm_plot$Internal_Axis$viewLabel, plot, _p20, axisPosition),
								A2(_terezka$elm_plot$Internal_Axis$toIndexInfo, _p21, labelValues))),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _terezka$elm_plot$Internal_Grid$viewLine = F3(
	function (config, meta, position) {
		return A3(
			_terezka$elm_plot$Internal_Line$view,
			meta,
			config,
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: meta.scales.x.bounds.lower, _1: position},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: meta.scales.x.bounds.upper, _1: position},
					_1: {ctor: '[]'}
				}
			});
	});
...
var _terezka$elm_plot$Internal_Grid$viewLines = F2(
	function (plot, _p1) {
		...
		return A2(
			_elm_lang$core$List$map,
			A2(_terezka$elm_plot$Internal_Grid$viewLine, _p2.lineStyle, plot),
			A2(_terezka$elm_plot$Internal_Grid$getValues, plot.scales.y.ticks, _p2.values));
	});
...
var _terezka$elm_plot$Internal_Bars$foldPoints = F3(
	function (_p5, _p4, points) {
		...
		var _p9 = _p7.xValue;
		if (_elm_lang$core$Native_Utils.eq(_p6.stackBy, _terezka$elm_plot$Plot_Attributes$X)) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				points,
				A2(
					_elm_lang$core$List$map,
					function (yValue) {
						return {ctor: '_Tuple2', _0: _p9, _1: yValue};
					},
					_p10));
		} else {
			var _p8 = A2(
...
var _terezka$elm_plot$Internal_Bars$toAutoWidth = F4(
	function (_p16, _p15, styleConfigs, groups) {
		...
		return (width * _p20.x.length) / _terezka$elm_plot$Internal_Scale$getRange(_p20.x);
	});
var _terezka$elm_plot$Internal_Bars$placeLabel = F3(
	function (width, _p21, label) {
		var _p22 = _p21;
		return A2(
			_elm_lang$svg$Svg$g,
			{
...
var _terezka$elm_plot$Internal_Bars$toLengthTouchingXAxis = F3(
	function (_p30, config, _p29) {
		var _p31 = _p30;
		var _p33 = _p31.scales;
		var _p32 = _p29;
		return ((_p32.yValue - A3(_elm_lang$core$Basics$clamp, _p33.y.bounds.lower, _p33.y.bounds.upper, 0)) * _p33.y.length) / _terezka$elm_plot$Internal_Scale$getRange(_p33.y);
	});
var _terezka$elm_plot$Internal_Bars$toLength = F3(
	function (plot, config, bar) {
		var _p34 = config.stackBy;
		if (_p34.ctor === 'X') {
			return A3(_terezka$elm_plot$Internal_Bars$toLengthTouchingXAxis, plot, config, bar);
		} else {
			return _elm_lang$core$Native_Utils.eq(bar.index, 0) ? A3(_terezka$elm_plot$Internal_Bars$toLengthTouchingXAxis, plot, config, bar) : ((bar.yValue * plot.scales.y.length) / _terezka$elm_plot$Internal_Scale$getRange(plot.scales.y));
		}
	});
var _terezka$elm_plot$Internal_Bars$toStackedCoords = F6(
	function (plot, config, styleConfigs, width, group, bar) {
				...
				plot.scales.x.toSvgCoords(
					{
						...
						_1: A2(
							...
							A2(_elm_lang$core$Basics$min, 0, plot.scales.y.bounds.upper),
							bar.yValue)
					}));
		} else {
			return A2(
				_terezka$elm_plot$Internal_Draw$addDisplacement,
				{
					...
					_1: A2(
						_elm_lang$core$Basics$min,
						0,
						A3(_terezka$elm_plot$Internal_Bars$toLength, plot, config, bar))
				},
				plot.scales.x.toSvgCoords(
					A2(
						_terezka$elm_plot$Internal_Draw$addDisplacement,
...
var _terezka$elm_plot$Internal_Bars$viewBar = F6(
	function (plot, width, _p36, config, styleConfig, info) {
		var _p37 = _p36;
		return A2(
								...
								_0: _elm_lang$svg$Svg_Attributes$height(
									_elm_lang$core$Basics$toString(
										_elm_lang$core$Basics$abs(
											A3(_terezka$elm_plot$Internal_Bars$toLength, plot, config, info)))),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$fill(styleConfig.fill),
									_1: {
										ctor: '::',
...
var _terezka$elm_plot$Internal_Bars$viewGroup = F5(
	function (plot, config, styleConfigs, width, group) {
		var toCoords = A5(_terezka$elm_plot$Internal_Bars$toStackedCoords, plot, config, styleConfigs, width, group);
		var labelInfos = A2(
			_elm_lang$core$List$indexedMap,
			F2(
				function (i, y) {
					return {index: i, xValue: group.xValue, yValue: y, text: ''};
				}),
			group.yValues);
		return A2(
			_elm_lang$svg$Svg$g,
...
var _terezka$elm_plot$Internal_Bars$view = F4(
	function (plot, config, styleConfigs, groups) {
		var width = A3(
			_terezka$elm_plot$Internal_Bars$toBarWidth,
			config,
			groups,
			A4(_terezka$elm_plot$Internal_Bars$toAutoWidth, plot, config, styleConfigs, groups));
		return A2(
			_elm_lang$svg$Svg$g,
			{ctor: '[]'},
			A2(
				_elm_lang$core$List$map,
				A4(_terezka$elm_plot$Internal_Bars$viewGroup, plot, config, styleConfigs, width),
				groups));
	});

var _terezka$elm_plot$Internal_Area$view = F3(
	function (plot, config, points) {
		var lowestY = A3(_elm_lang$core$Basics$clamp, plot.scales.y.bounds.lower, plot.scales.y.bounds.upper, 0);
		var _p0 = _terezka$elm_plot$Internal_Scale$getEdgesX(points);
		var lowestX = _p0._0;
		var highestX = _p0._1;
		var instructions = A2(
			_terezka$elm_plot$Internal_Draw$toPath,
			...
			_elm_lang$core$List$concat(
				{
					...
					_0: {
						ctor: '::',
						_0: _terezka$elm_plot$Internal_Draw$M(
							{ctor: '_Tuple2', _0: lowestX, _1: lowestY}),
						_1: {ctor: '[]'}
					},
					_1: {
						ctor: '::',
						_0: A2(_terezka$elm_plot$Internal_Draw$toLinePath, config.interpolation, points),
						_1: {
							ctor: '::',
							_0: {
								ctor: '::',
								_0: _terezka$elm_plot$Internal_Draw$L(
									{ctor: '_Tuple2', _0: highestX, _1: lowestY}),
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$Internal_Draw$Z,
									_1: {ctor: '[]'}
								}
							},
							_1: {ctor: '[]'}
...
var _terezka$elm_plot$Internal_Scatter$view = F3(
	function (plot, _p2, points) {
		var _p3 = _p2;
		var svgPoints = A2(_elm_lang$core$List$map, plot.scales.x.toSvgCoords, points);
		return A2(
			_elm_lang$svg$Svg$g,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$fill(_p3.fill),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$stroke(_p3.stroke),
					_1: {ctor: '[]'}
				}
			},
			A2(
				_elm_lang$core$List$map,
				_terezka$elm_plot$Internal_Scatter$toSvgCircle(_p3.radius),
				svgPoints));
	});
...
var _terezka$elm_plot$Internal_Hint$defaultView = function (_p3) {
	var _p4 = _p3;
	var _p5 = _p4.isLeftSide;
	var classes = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'elm-plot__hint__default-view', _1: true},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'elm-plot__hint__default-view--left', _1: _p5},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'elm-plot__hint__default-view--right', _1: !_p5},
				_1: {ctor: '[]'}
			}
		}
	};
...
var _terezka$elm_plot$Internal_Hint$view = F3(
	function (plot, _p6, position) {
		var _p7 = _p6;
		var viewHint = A2(_elm_lang$core$Maybe$withDefault, _terezka$elm_plot$Internal_Hint$defaultView, _p7.view);
		var xPosition = _elm_lang$core$Tuple$first(position);
		var info = plot.getHintInfo(xPosition);
		var _p8 = plot.scales.x.toSvgCoords(
			{ctor: '_Tuple2', _0: info.xValue, _1: 0});
		var xSvg = _p8._0;
		var ySvg = _p8._1;
		var isLeftSide = _elm_lang$core$Native_Utils.cmp(xSvg - plot.scales.x.offset.lower, plot.scales.x.length / 2) < 0;
		var infoWithPosition = _elm_lang$core$Native_Utils.update(
			info,
		...
		var lineView = A3(
			...
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: xPosition, _1: plot.scales.y.bounds.upper},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: xPosition, _1: plot.scales.y.bounds.lower},
					_1: {ctor: '[]'}
				}
			});
		return {
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								...
								_1: {
									...
									_0: {
										ctor: '_Tuple2',
										_0: 'top',
										_1: _terezka$elm_plot$Internal_Draw$toPixels(plot.scales.y.offset.lower)
									},
									_1: {
										ctor: '::',
...
var _terezka$elm_plot$Plot$getYValue = F3(
	function (xValue, _p0, result) {
		var _p1 = _p0;
		return _elm_lang$core$Native_Utils.eq(_p1._0, xValue) ? _elm_lang$core$Maybe$Just(
			{
				ctor: '::',
				_0: _p1._1,
				_1: {ctor: '[]'}
	...
	function (xValue, element, yValues) {
		...
		switch (_p2.ctor) {
			case 'Area':
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Plot$collectYValue, xValue, _p2._1),
					_1: yValues
				};
			case 'Line':
				return {
			...
			case 'Bars':
				return {
					ctor: '::',
					_0: A2(_terezka$elm_plot$Internal_Bars$getYValues, xValue, _p2._2),
					_1: yValues
				};
			default:
				return yValues;
...
var _terezka$elm_plot$Plot$applyAttributes = F2(
	function (attrs, plot) {
		return A3(
			_elm_lang$core$List$foldr,
			F2(
...
var _terezka$elm_plot$Plot$finishPlotConfig = F2(
	function (elements, plot) {
		return _elm_lang$core$Native_Utils.update(
			plot,
			{
...
var _terezka$elm_plot$Plot$addAxisTicks = F2(
	function (elements, plot) {
		return A3(
			_elm_lang$core$List$foldl,
			F2(
				function (element, plot) {
					var _p3 = element;
					if (_p3.ctor === 'Axis') {
						var _p5 = _p3._0;
						var _p4 = _p5.orientation;
						if (_p4.ctor === 'X') {
							return A2(
								_terezka$elm_plot$Internal_Scale$updatePlotScales,
								plot,
								A3(
									_terezka$elm_plot$Internal_Scale$updatePlotTicks,
									_p5.orientation,
									plot.scales,
									A2(_terezka$elm_plot$Internal_Axis$getValues, _p5.tick.values, plot.scales.x)));
						} else {
							return A2(
								_terezka$elm_plot$Internal_Scale$updatePlotScales,
								plot,
								A3(
									...
									_p5.orientation,
									plot.scales,
									A2(_terezka$elm_plot$Internal_Axis$getValues, _p5.tick.values, plot.scales.y)));
						}
					} else {
						return plot;
					}
...
var _terezka$elm_plot$Plot$collectElementBounds = F2(
	function (element, result) {
		...
		switch (_p6.ctor) {
			case 'Line':
				return {
					ctor: '::',
					_0: _terezka$elm_plot$Internal_Scale$updateBoundsFromPoints(_p6._1),
					_1: result
				};
			case 'Area':
				return {
					ctor: '::',
					_0: _terezka$elm_plot$Internal_Scale$updateBoundsArea(_p6._1),
					_1: result
				};
			case 'Scatter':
				return {
			...
			case 'Bars':
				return {
					ctor: '::',
					_0: _terezka$elm_plot$Internal_Scale$updateBoundsBars(
						A2(_terezka$elm_plot$Internal_Bars$toPoints, _p6._0, _p6._2)),
					_1: result
				};
			default:
				return result;
...
var _terezka$elm_plot$Plot$addPlotBounds = F2(
	function (elements, plot) {
		var elementBounds = A3(
			_elm_lang$core$List$foldl,
			_terezka$elm_plot$Plot$collectElementBounds,
			{ctor: '[]'},
			elements);
		var _p7 = elementBounds;
		if (_p7.ctor === '[]') {
			return plot;
		} else {
			return A2(
				...
				plot,
				A2(
					_terezka$elm_plot$Internal_Scale$updatePlotBounds,
					plot.scales,
					A3(_elm_lang$core$List$foldl, _terezka$elm_plot$Internal_Scale$foldBounds, _p7._0, _p7._1)));
		}
	});
var _terezka$elm_plot$Plot$applyElements = F2(
	function (elements, plot) {
		return A2(
			_terezka$elm_plot$Plot$finishPlotConfig,
			elements,
			A2(
				_terezka$elm_plot$Plot$addAxisTicks,
				elements,
				A2(_terezka$elm_plot$Plot$addPlotBounds, elements, plot)));
	});
var _terezka$elm_plot$Plot$viewElement = F3(
	function (plot, element, _p8) {
		var _p9 = _p8;
		var _p14 = _p9._0;
		var _p13 = _p9._1;
		var _p10 = element;
		switch (_p10.ctor) {
			case 'Line':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Line$view, plot, _p10._0, _p10._1),
						_1: _p14
					},
					_1: _p13
				};
			case 'Area':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Area$view, plot, _p10._0, _p10._1),
						_1: _p14
					},
					_1: _p13
				};
			case 'Scatter':
				return {
					...
					_0: {
						ctor: '::',
						_0: A3(_terezka$elm_plot$Internal_Scatter$view, plot, _p10._0, _p10._1),
						_1: _p14
					},
					_1: _p13
				};
			case 'Bars':
				return {
					...
					_0: {
						ctor: '::',
						_0: A4(_terezka$elm_plot$Internal_Bars$view, plot, _p10._0, _p10._1, _p10._2),
						_1: _p14
					},
					_1: _p13
				};
				...
				return {
					...
					_0: {
						...
						_0: A2(
							...
							A2(_terezka$elm_plot$Internal_Scale$flipPlotToOrientation, _p10._0.orientation, plot),
							_p10._0),
						_1: _p14
					},
					_1: _p13
			...
			case 'CustomElement':
				return {
					...
					_0: {
						ctor: '::',
						_0: _p10._0(plot.scales.x.toSvgCoords),
						_1: _p14
					},
					_1: _p13
				};
			default:
				var _p11 = _p10._1;
				if (_p11.ctor === 'Just') {
					var _p12 = A3(_terezka$elm_plot$Internal_Hint$view, plot, _p10._0, _p11._0);
					var line = _p12._0;
					var hint = _p12._1;
					return {
						ctor: '_Tuple2',
						_0: {ctor: '::', _0: line, _1: _p14},
						_1: {ctor: '::', _0: hint, _1: _p13}
					};
				} else {
...
var _terezka$elm_plot$Plot$viewElements = F2(
	function (plot, elements) {
		return A3(
			_elm_lang$core$List$foldr,
			_terezka$elm_plot$Plot$viewElement(plot),
			{
				ctor: '_Tuple2',
				_0: {ctor: '[]'},
				_1: {ctor: '[]'}
...
var _terezka$elm_plot$Plot$sizeStyle = function (scales) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'height',
			_1: _terezka$elm_plot$Internal_Draw$toPixels(scales.y.length)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'width',
				_1: _terezka$elm_plot$Internal_Draw$toPixels(scales.x.length)
			},
			_1: {ctor: '[]'}
		}
	};
};
var _terezka$elm_plot$Plot$scaleDefs = function (plot) {
	return A2(
				...
				},
				{
					...
					_0: A2(
						_elm_lang$svg$Svg$rect,
						{
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$x(
								_elm_lang$core$Basics$toString(plot.scales.x.offset.lower)),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$y(
									_elm_lang$core$Basics$toString(plot.scales.y.offset.lower)),
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$width(
										_elm_lang$core$Basics$toString(plot.scales.x.length)),
									_1: {
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$height(
											_elm_lang$core$Basics$toString(plot.scales.y.length)),
										_1: {ctor: '[]'}
									}
								}
							}
	...
	function (plot, views) {
		return A2(
			_elm_lang$svg$Svg$svg,
			{
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$height(
					_elm_lang$core$Basics$toString(plot.scales.y.lengthTotal)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(plot.scales.x.lengthTotal)),
					_1: {
						ctor: '::',
			...
			{
				ctor: '::',
				_0: _terezka$elm_plot$Plot$scaleDefs(plot),
				_1: views
			});
	});
var _terezka$elm_plot$Plot$plotAttributes = function (_p15) {
	var _p16 = _p15;
	return {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id(_p16.id),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$style(
					A2(
						_elm_lang$core$Basics_ops['++'],
						_terezka$elm_plot$Plot$sizeStyle(_p16.scales),
						_p16.style)),
				_1: {ctor: '[]'}
			}
		}
...
var _terezka$elm_plot$Plot$viewPlot = F2(
	function (plot, _p17) {
		...
		return A2(
			_elm_lang$html$Html$div,
			_terezka$elm_plot$Plot$plotAttributes(plot),
			{
				ctor: '::',
				_0: A2(_terezka$elm_plot$Plot$viewSvg, plot, _p18._0),
				_1: _p18._1
			});
	});
var _terezka$elm_plot$Plot$parsePlot = F2(
	function (plot, elements) {
		return A2(
			...
			plot,
			A2(_terezka$elm_plot$Plot$viewElements, plot, elements));
	});
var _terezka$elm_plot$Plot$getPosition = A2(
	_elm_lang$core$Json_Decode$map,
	function (_p19) {
		var _p20 = _p19;
		return {ctor: '_Tuple2', _0: _p20.left, _1: _p20.top};
	},
...
var _terezka$elm_plot$Plot$getRelativePosition = F3(
	function (plot, _p23, _p22) {
		var _p24 = _p23;
		var _p25 = _p22;
		var _p26 = plot.scales.x.fromSvgCoords(
			{ctor: '_Tuple2', _0: _p24._0 - _p25._0, _1: _p24._1 - _p25._1});
		var x = _p26._0;
		var y = _p26._1;
		return {
			ctor: '_Tuple2',
			_0: A2(_terezka$elm_plot$Internal_Scale$toNearestX, plot.scales, x),
			_1: y
		};
	});
var _terezka$elm_plot$Plot$shouldPositionUpdate = F2(
	function (_p28, _p27) {
		var _p29 = _p28;
		var _p30 = _p27;
		var _p31 = _p29.position;
		if (_p31.ctor === 'Nothing') {
			return true;
		} else {
			return (!_elm_lang$core$Native_Utils.eq(_p31._0._1, _p30._1)) || (!_elm_lang$core$Native_Utils.eq(_p31._0._0, _p30._0));
		}
	});
var _terezka$elm_plot$Plot$getHoveredValue = function (_p32) {
	var _p33 = _p32;
	return _p33._0.position;
};
var _terezka$elm_plot$Plot$toPlotConfig = F2(
	function (attrs, elements) {
		return _terezka$elm_plot$Internal_Scale$postProcessPlot(
			A2(
				_terezka$elm_plot$Plot$applyAttributes,
				attrs,
				A2(_terezka$elm_plot$Plot$applyElements, elements, _terezka$elm_plot$Plot_Attributes$defaultConfig)));
	});
var _terezka$elm_plot$Plot$plot = F2(
	function (attrs, elements) {
		return A3(
			...
			A2(_terezka$elm_plot$Plot$toPlotConfig, attrs, elements),
			elements);
	});
...
var _terezka$elm_plot$Plot$xAxis = function (attrs) {
	return _terezka$elm_plot$Plot$Axis(
		A3(
			...
			_terezka$elm_plot$Plot_Attributes$defaultAxisConfig,
			attrs));
};
var _terezka$elm_plot$Plot$yAxis = function (attrs) {
	return _terezka$elm_plot$Plot$Axis(
		A3(
			...
			_elm_lang$core$Native_Utils.update(
				_terezka$elm_plot$Plot_Attributes$defaultAxisConfig,
				{orientation: _terezka$elm_plot$Plot_Attributes$Y}),
			attrs));
};
...
var _terezka$elm_plot$Plot$horizontalGrid = function (attrs) {
	return _terezka$elm_plot$Plot$Grid(
		A3(
			...
			_terezka$elm_plot$Plot_Attributes$defaultGridConfig,
			attrs));
};
	...
	function (attrs, position) {
		return A2(
			...
			A3(
				...
				_terezka$elm_plot$Plot_Attributes$defaultHintConfig,
				attrs),
			position);
	});
...
var _terezka$elm_plot$Plot$scatter = function (attrs) {
	return _terezka$elm_plot$Plot$Scatter(
		A3(
			...
			_terezka$elm_plot$Plot_Attributes$defaultScatterConfig,
			attrs));
};
	...
	function (attrs, styleAttrsList, groups) {
		return A3(
			...
			A3(
				...
				_terezka$elm_plot$Plot_Attributes$defaultBarsConfig,
				attrs),
			A2(
				_elm_lang$core$List$map,
				A2(
					...
					_terezka$elm_plot$Plot_Attributes$defaultBarsStyle),
				styleAttrsList),
			groups);
	});
...
var _terezka$elm_plot$Plot$update = F2(
	function (msg, _p34) {
		...
		var _p38 = _p35._0;
		var _p36 = msg;
		if (_p36.ctor === 'Hovering') {
			var _p37 = _p36._0;
			return A2(_terezka$elm_plot$Plot$shouldPositionUpdate, _p38, _p37) ? _terezka$elm_plot$Plot$State(
				_elm_lang$core$Native_Utils.update(
					_p38,
					{
						position: _elm_lang$core$Maybe$Just(_p37)
					})) : _terezka$elm_plot$Plot$State(_p38);
		} else {
...
var _terezka$elm_plot$Plot$handleMouseOver = function (plot) {
	return A4(
		_elm_lang$core$Json_Decode$map3,
		_terezka$elm_plot$Plot$toMouseOverMsg(plot),
...
var _terezka$elm_plot$Plot$plotAttributesInteraction = function (plot) {
	return {
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html_Events$on,
			'mousemove',
			_terezka$elm_plot$Plot$handleMouseOver(plot)),
		_1: {
			ctor: '::',
...
var _terezka$elm_plot$Plot$viewPlotInteractive = F2(
	function (plot, _p40) {
		var _p41 = _p40;
		return A2(
			_elm_lang$html$Html$div,
			A2(
				_elm_lang$core$Basics_ops['++'],
				_terezka$elm_plot$Plot$plotAttributes(plot),
				_terezka$elm_plot$Plot$plotAttributesInteraction(plot)),
			{
				ctor: '::',
				_0: A2(_terezka$elm_plot$Plot$viewSvg, plot, _p41._0),
				_1: _p41._1
			});
	});
...
var _terezka$elm_plot$Plot$plotInteractive = F2(
	function (attrs, elements) {
		return A3(
			_elm_lang$svg$Svg_Lazy$lazy2,
...
var _terezka$elm_plot$PlotComposed$labelStyle = {
	ctor: '::',
	_0: _terezka$elm_plot$Plot_Attributes$fontSize(12),
	_1: {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Attributes$displace(
...
var _terezka$elm_plot$PlotComposed$toTickStyle = function (_p2) {
	...
	return _terezka$elm_plot$PlotComposed$isOdd(_p3.index) ? {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Attributes$length(7),
		_1: {
			ctor: '::',
			_0: _terezka$elm_plot$Plot_Attributes$stroke('#e4e3e3'),
			_1: {ctor: '[]'}
		}
	} : {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Attributes$length(10),
		_1: {
			ctor: '::',
			_0: _terezka$elm_plot$Plot_Attributes$stroke('#b9b9b9'),
			_1: {ctor: '[]'}
		}
	};
};
...
var _terezka$elm_plot$PlotComposed$view = function (state) {
	return A2(
		...
		{
			ctor: '::',
			_0: _terezka$elm_plot$Plot_Attributes$size(
				{ctor: '_Tuple2', _0: 800, _1: 400}),
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Attributes$padding(
					{ctor: '_Tuple2', _0: 40, _1: 40}),
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot_Attributes$margin(
						{ctor: '_Tuple4', _0: 15, _1: 20, _2: 40, _3: 15}),
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$id('ComposedPlot'),
						_1: {ctor: '[]'}
					}
				}
			}
		},
		{
			...
			_0: _terezka$elm_plot$Plot$horizontalGrid(
				{
					ctor: '::',
					_0: _terezka$elm_plot$Plot_Attributes$lineStyle(
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Attributes$stroke('#f2f2f2'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Attributes$stroke(_terezka$elm_plot$Common$skinStroke),
							_1: {
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$fill(_terezka$elm_plot$Common$skinFill),
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Attributes$opacity(0.5),
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Attributes$interpolation(_terezka$elm_plot$Plot_Attributes$Bezier),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$stroke(_terezka$elm_plot$Common$blueStroke),
								_1: {
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Attributes$fill(_terezka$elm_plot$Common$blueFill),
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Attributes$interpolation(_terezka$elm_plot$Plot_Attributes$Bezier),
										_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Attributes$stroke(_terezka$elm_plot$Common$pinkStroke),
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Attributes$interpolation(_terezka$elm_plot$Plot_Attributes$Bezier),
										_1: {
											ctor: '::',
											_0: _terezka$elm_plot$Plot_Attributes$strokeWidth(2),
											_1: {ctor: '[]'}
										}
									}
								},
							...
							_1: {
								...
								_1: {
									...
									_0: _terezka$elm_plot$Plot$yAxis(
										{
											ctor: '::',
											_0: _terezka$elm_plot$Plot_Attributes$anchor(_terezka$elm_plot$Plot_Attributes$AnchorInner),
											_1: {
												ctor: '::',
												_0: _terezka$elm_plot$Plot_Attributes$clearIntersections,
												_1: {
													ctor: '::',
													_0: _terezka$elm_plot$Plot_Attributes$position(_terezka$elm_plot$Plot_Attributes$PositionLowest),
													_1: {
														ctor: '::',
														_0: _terezka$elm_plot$Plot_Attributes$lineStyle(
															{
														...
														_1: {
															ctor: '::',
															_0: _terezka$elm_plot$Plot_Attributes$tick(
																{
																	ctor: '::',
																	_0: _terezka$elm_plot$Plot_Attributes$values(
																		_terezka$elm_plot$Plot_Attributes$ValuesFromDelta(50)),
																	_1: {ctor: '[]'}
																}),
															_1: {
																ctor: '::',
																_0: _terezka$elm_plot$Plot_Attributes$label(
																	{
																		ctor: '::',
																		_0: _terezka$elm_plot$Plot_Attributes$viewStatic(_terezka$elm_plot$PlotComposed$labelStyle),
																		_1: {
																			ctor: '::',
																			_0: _terezka$elm_plot$Plot_Attributes$format(
																				_terezka$elm_plot$Plot_Attributes$FormatFromFunc(
																					function (_p8) {
																						var _p9 = _p8;
																						return A2(
																							_elm_lang$core$Basics_ops['++'],
														...
														_0: _terezka$elm_plot$Plot_Attributes$tick(
															{
																ctor: '::',
																_0: _terezka$elm_plot$Plot_Attributes$values(
																	_terezka$elm_plot$Plot_Attributes$ValuesFromDelta(2.5)),
																_1: {
																	ctor: '::',
																	_0: _terezka$elm_plot$Plot_Attributes$viewDynamic(_terezka$elm_plot$PlotComposed$toTickStyle),
																	_1: {ctor: '[]'}
																}
															}),
														_1: {
															...
															_0: _terezka$elm_plot$Plot_Attributes$label(
																{
																	ctor: '::',
																	_0: _terezka$elm_plot$Plot_Attributes$viewStatic(
																		{
																			ctor: '::',
																			_0: _terezka$elm_plot$Plot_Attributes$fontSize(12),
																			_1: {
...
var _terezka$elm_plot$PlotScatter$view = A2(
	...
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Attributes$size(_terezka$elm_plot$Common$plotSize),
		_1: {
			ctor: '::',
			_0: _terezka$elm_plot$Plot_Attributes$margin(
			...
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Attributes$domainLowest(
	...
	},
	{
		...
		_0: A2(
			_terezka$elm_plot$Plot$scatter,
			{
				...
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot_Attributes$fill(_terezka$elm_plot$Common$pinkFill),
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$radius(8),
						_1: {ctor: '[]'}
					}
				}
			},
			...
			_0: _terezka$elm_plot$Plot$xAxis(
				{
					...
					_0: _terezka$elm_plot$Plot_Attributes$lineStyle(
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Attributes$stroke(_terezka$elm_plot$Common$axisColor),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$tick(
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$values(
									_terezka$elm_plot$Plot_Attributes$ValuesFromDelta(2)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
		...
		_0: _terezka$elm_plot$Plot$verticalGrid(
			{
				...
				_0: _terezka$elm_plot$Plot_Attributes$lineStyle(
					{
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$stroke(_terezka$elm_plot$Common$axisColorLight),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}),
			...
			_0: _terezka$elm_plot$Plot$horizontalGrid(
				{
					...
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$values(
							_terezka$elm_plot$Plot_Attributes$ValuesFromList(
								{
									ctor: '::',
									_0: 4,
									_1: {
							...
							_0: _terezka$elm_plot$Plot_Attributes$tick(
								{
									ctor: '::',
									_0: _terezka$elm_plot$Plot_Attributes$values(
										_terezka$elm_plot$Plot_Attributes$ValuesFromDelta(0.5)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
				...
				_1: {
					...
					_0: A2(
						_terezka$elm_plot$Plot$line,
						{
							...
							_1: {
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$strokeWidth(3),
								_1: {ctor: '[]'}
							}
						},
...
var _terezka$elm_plot$PlotTicks$toLabelStyle = function (_p2) {
	...
	return _terezka$elm_plot$PlotTicks$isOdd(_p3.index) ? {ctor: '[]'} : {
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Attributes$stroke('#969696'),
		_1: {ctor: '[]'}
	};
};
			...
			_0: _terezka$elm_plot$Plot$xAxis(
				{
					...
					_1: {
						...
						_0: _terezka$elm_plot$Plot_Attributes$tick(
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$viewDynamic(_terezka$elm_plot$PlotTicks$toTickStyle),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Attributes$label(
								{
									...
									_1: {
										ctor: '::',
										_0: _terezka$elm_plot$Plot_Attributes$viewDynamic(_terezka$elm_plot$PlotTicks$toLabelStyle),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _terezka$elm_plot$PlotBars$view = A2(
	...
	},
	{
		...
		_0: A3(
			...
			{
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Attributes$maxBarWidth(30),
				_1: {
					ctor: '::',
					_0: _terezka$elm_plot$Plot_Attributes$stackByY,
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$label(
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$format(
									_terezka$elm_plot$Plot_Attributes$FormatFromList(
										{
											ctor: '::',
											_0: 'A',
											_1: {
									...
									_0: _terezka$elm_plot$Plot_Attributes$viewStatic(
										{
											...
											_1: {
												ctor: '::',
												_0: _terezka$elm_plot$Plot_Attributes$fontSize(10),
												_1: {ctor: '[]'}
											}
										}),
									_1: {ctor: '[]'}
						...
						_0: _terezka$elm_plot$Plot_Attributes$tick(
							{
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$values(
									_terezka$elm_plot$Plot_Attributes$ValuesFromDelta(1)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _terezka$elm_plot$PlotSticky$tickStyles = {
	ctor: '::',
	_0: _terezka$elm_plot$Plot_Attributes$length(7),
	_1: {
		ctor: '::',
...
var _terezka$elm_plot$PlotSticky$viewPlot = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Attributes$size(_terezka$elm_plot$Common$plotSize),
		...
		_1: {
			...
			_0: _terezka$elm_plot$Plot$xAxis(
				{
					...
					_0: _terezka$elm_plot$Plot_Attributes$tick(
						{
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Attributes$viewStatic(_terezka$elm_plot$PlotSticky$tickStyles),
							_1: {
								ctor: '::',
								_0: _terezka$elm_plot$Plot_Attributes$values(
									_terezka$elm_plot$Plot_Attributes$ValuesFromList(
			...
			_1: {
				...
				_0: _terezka$elm_plot$Plot$yAxis(
					{
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$position(_terezka$elm_plot$Plot_Attributes$PositionHighest),
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Attributes$clearIntersections,
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_0: _terezka$elm_plot$Plot_Attributes$label(
											{
												ctor: '::',
												_0: _terezka$elm_plot$Plot_Attributes$viewDynamic(_terezka$elm_plot$PlotSticky$toLabelAttrsY),
												_1: {
													ctor: '::',
													_0: _terezka$elm_plot$Plot_Attributes$format(
														_terezka$elm_plot$Plot_Attributes$FormatFromFunc(
...
var _terezka$elm_plot$PlotSticky$plotExample = {
	...
	view: _terezka$elm_plot$Common$ViewStatic(_terezka$elm_plot$PlotSticky$viewPlot),
	...
	return A2(
		...
		},
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _terezka$elm_plot$Plot_Attributes$maxBarWidthPer(85),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _terezka$elm_plot$PlotSmooth$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		...
		_1: {
			...
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Attributes$domainHighest(
					function (y) {
						return y + 1;
					}),
				_1: {
		...
		_0: A2(
			_terezka$elm_plot$Plot$area,
			{
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _terezka$elm_plot$Plot_Attributes$strokeWidth(1),
						_1: {
							ctor: '::',
							_0: _terezka$elm_plot$Plot_Attributes$interpolation(_terezka$elm_plot$Plot_Attributes$Bezier),
							_1: {ctor: '[]'}
...
var _terezka$elm_plot$PlotLines$view = A2(
	_terezka$elm_plot$Plot$plot,
	{
		ctor: '::',
		_0: _terezka$elm_plot$Plot_Attributes$size(
			{ctor: '_Tuple2', _0: 400, _1: 300}),
		_1: {
			ctor: '::',
			_0: _terezka$elm_plot$Plot_Attributes$margin(
				{ctor: '_Tuple4', _0: 30, _1: 30, _2: 30, _3: 30}),
			_1: {
				ctor: '::',
				_0: _terezka$elm_plot$Plot_Attributes$id('lines'),
				_1: {ctor: '[]'}
			}
		}
	},
...
var _terezka$elm_plot$Docs$examples2 = {
	ctor: '::',
...
var _terezka$elm_plot$Docs$examples = {ctor: '[]'};
